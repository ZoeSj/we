...
import com.example.wework.HDPView;
import com.example.wework.ItemImg;
import com.mingrisoft.Chi;
import com.worldchip.apk.JoyImageViewActivity;
...
public class MainWeixin extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		h = (HDPView) findViewById(R.id.hDPView1);
		ImageButton eatbtn = (ImageButton) findViewById(R.id.eat_btn);
		// 启动activity时不自动弹出软键盘
		...
		// mTab5 = (ImageView) findViewById(R.id.img_up);
	...
	public void boygirl(View v) {
		Intent intent = new Intent(MainWeixin.this, ViewPicturesActivity.class);
		startActivity(intent);

	}
	public void girl(View v) {
		Intent intent = new Intent(MainWeixin.this, CopyOfViewPicturesActivity.class);
		startActivity(intent);

	}

	public void file(View v) {
		Toast.makeText(getApplicationContext(), "此功能暂不开放", Toast.LENGTH_LONG)
		.show();
